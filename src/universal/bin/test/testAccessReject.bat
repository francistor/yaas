...
echo User-Name = "test@reject" > %REQUESTFILE%
echo User-Password = "This is the password !" >> %REQUESTFILE%

REM Send the packet
%RADIUS% -debug debug -count %COUNT% -remoteAddress 127.0.0.1:1812 -code Access-Request -request "@%REQUESTFILE%"
