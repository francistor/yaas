...
RADIUS CLIENT
REM call start "SERVER" %BIN_DIR%\aaaserver -Dinstance=radius -Dconfig.file=/code/yaasws/yaas/src/k8/conf/client/aaa-default.conf -Dlogback.configurationFile=/code/yaasws/yaas/src/k8/conf/client/logback-default.xml
